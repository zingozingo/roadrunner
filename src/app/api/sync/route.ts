...
const VALID_ENTITIES = new Set(["partners", "programs", "events", "relationships", "engagements", "meetings"]);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = entity
      ? await syncEntity(entity as "partners" | "programs" | "events" | "relationships" | "engagements" | "meetings")
