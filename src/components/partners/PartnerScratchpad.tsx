...
const SOURCE_BADGES: Record<string, { label: string; className: string }> = {
  seed_dump: { label: "SEED", className: "bg-purple-500/15 text-purple-400" },
  ai_synthesis: { label: "AI", className: "bg-blue-500/15 text-blue-400" },
};
...
export default function PartnerScratchpad({
  ...
  const [entries, setEntries] = useState<PartnerContextEntry[]>(initialEntries);
  ...
  return (
    <div className="rounded-xl border border-border bg-surface p-4">
      ...
      <input
        ...
        placeholder={
          entries.length === 0
            ? "Start adding context — notes, intel, reminders..."
            : "Add context about this partner..."
        }
        disabled={submitting}
