...
> 84 migrations · 17 tables · 35 API routes · 14 UI pages · 444 passing tests
...
├── decisions.md                   # Append-only architectural decision log (412 entries)
├── src/
...
├── supabase/
│   ├── migrations/                # 83 migration files (001-083)
...
| `decisions.md` | Append-only architectural decision log (412 entries) | When you need "why" |
