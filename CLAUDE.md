...
├── decisions.md                   # Append-only architectural decision log (405 entries)
├── src/
...
├── supabase/
│   ├── migrations/                # 82 migration files (001-082)
...
| `decisions.md` | Append-only architectural decision log (405 entries) | When you need "why" |
